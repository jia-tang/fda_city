...
def parse_args():
  ...
  parser.add_argument('--save_dir', dest='save_dir',
                      help='directory to save models', default="/home/jia/weights",
                      type=str)
...
if __name__ == '__main__':
  ...
  elif args.dataset == "bdd3k":
      print('loading our dataset...........')
      args.s_imdb_name = "voc_2007_train_s"
      args.t_imdb_name = "voc_2007_train_t"
      args.s_imdbtest_name="voc_2007_test_s"
      args.t_imdbtest_name="voc_2007_test_t"
      args.set_cfgs = ['ANCHOR_SCALES', '[4,8,16,32]', 'ANCHOR_RATIOS', '[0.5,1,2]', 'MAX_NUM_GT_BOXES', '50']
  ...
  if args.net == 'vgg16':
    ...
    fasterRCNN = resnetDA_transmission_fda(s_imdb.classes, 101, pretrained=True, class_agnostic=args.class_agnostic)
  else:
  ...
  if args.resume:
    load_name = os.path.join(output_dir,
      'da_faster_rcnn_{}_{}_{}.pth'.format(args.checksession, args.checkepoch, args.checkpoint))
  ...
  if args.use_tfboard:
    ...
    logger =  SummaryWriter("/home/jia/da-bdd/logs/")
  ...
  for epoch in range(args.start_epoch, args.max_epochs + 1):
    ...
    if epoch%2 == 0 and epoch != 0:
        save_name = os.path.join(output_dir, 'da_faster_rcnn_{}_{}_{}.pth'.format(args.session, epoch, step))
        save_checkpoint({
