# changed output_dir to output_dir = '/home/jia/da/datasets/'
...
def parse_args():
  ...
  parser.add_argument('--model_dir', dest='model_dir',
                      help='directory to load models', default="/home/jia/fda_city/weights/vgg16/pascal_voc/cityscape_consist_default.pth",
                      type=str)
...
if __name__ == '__main__':
  ...
  output_dir = '/home/jia/fda_city/datasets/'
      ...
      if cfg.TEST.BBOX_REG:
          ...
          # Optionally normalize targets by a precomputed mean and stdev
            if args.class_agnostic:
                box_deltas = box_deltas.view(-1, 4) * torch.cuda.FloatTensor(cfg.TRAIN.BBOX_NORMALIZE_STDS) \
                           + torch.cuda.FloatTensor(cfg.TRAIN.BBOX_NORMALIZE_MEANS)
